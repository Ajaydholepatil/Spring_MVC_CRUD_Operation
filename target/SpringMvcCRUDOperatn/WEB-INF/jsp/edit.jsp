...
<body>
<form:form method="post" action="/CrudOperation/edit">
<table>
<tr>
<td>Roll no</td>
...
<tr>
<td>Student Name </td>
<td><form:input path="name"></from:input></td>
</tr>

<tr>
<td>Qualifiaction </td>
<td><form:input path="qualification"></from:input></td>
</tr>

<tr>
<td>Percentage</td>
<td><form:input path="percentage"></from:input></td>
</tr>
